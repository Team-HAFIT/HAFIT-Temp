...
const Movenet = () => {
  ...
  const minconfidenceThreshold = 0.3;   //최소 정확도
  ...
  let kneeAngleThreshold = 130;         //무릎 각도(스쿼트)
  let kneeAnglewarringThreshold  = 80;
  let orangeHurryAngleThreshold = 20;   //허리 각도(굽혀경고)
  ...
  const drawSkeleton = () => {
    ...
    if (posesRef.current && posesRef.current.length > 0) {
      ...
      if (hurryKeypointsConfident && hurrycheck > orangeHurryAngleThreshold && hurrycheck <= redHurryAngleThreshold) {
      ...
      } else if (hurryKeypointsConfident && hurrycheck > redHurryAngleThreshold) {
        setIsOrangeDetected(false);
          ...
          <div id="main1">
            <div id= "Excellentstate">
              <div id = "Excellent">
                ...
                <span id="textE">{excellentCount}</span>
              </div>  
            </div>
            <div id= "goodstate">
              <div id="good">
                <span id="textE">good</span>
                <span id="textE">{goodCount}</span>
              </div>
            </div>
            <div id= "badstate">
              <div id="bad">
                <span id="textE">bad</span>
                <span id="textE">{badCount}</span>
              </div>
            </div>
          </div>
          <div id="main2">
